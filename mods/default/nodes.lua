...
minetest.register_node("default:leaves", {
	...
	paramtype = "light",
	is_ground_content = false,
	groups = {dig_immediate=3,snappy=3, leafdecay=3, flammable=2, leaves=1},
	drop = {
		max_items = 1,
		items = {
			{
...
minetest.register_node("default:cactus", {
	...
	paramtype2 = "facedir",
	groups = {dig_immediate=3,snappy=1,choppy=3,flammable=2},
	sounds = default.node_sound_wood_defaults(),
	on_place = minetest.rotate_node,
...
minetest.register_node("default:dry_shrub", {
	...
	walkable = false,
	buildable_to = true,
	groups = {dig_immediate=3,snappy=3,flammable=3,attached_node=1},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
...
minetest.register_node("default:junglegrass", {
	...
	walkable = false,
	buildable_to = true,
	groups = {dig_immediate=3,snappy=3,flammable=2,flora=1,attached_node=1},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
		fixed = {-0.5, -0.5, -0.5, 0.5, -5/16, 0.5},
...
minetest.register_node("default:grass_1", {
	...
	walkable = false,
	buildable_to = true,
	groups = {dig_immediate=3,snappy=3,flammable=3,flora=1,attached_node=1},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
		fixed = {-0.5, -0.5, -0.5, 0.5, -5/16, 0.5},
...
for i=2,5 do
	minetest.register_node("default:grass_"..i, {
		...
		groups = {dig_immediate=3,snappy=3,flammable=3,flora=1,attached_node=1,not_in_creative_inventory=1},
		sounds = default.node_sound_leaves_defaults(),
		selection_box = {
			type = "fixed",
			fixed = {-0.5, -0.5, -0.5, 0.5, -5/16, 0.5},
...
minetest.register_node("default:glass", {
	...
	sunlight_propagates = true,
	is_ground_content = false,
	groups = {dig_immediate=3,cracky=3,oddly_breakable_by_hand=3},
	sounds = default.node_sound_glass_defaults(),
})
