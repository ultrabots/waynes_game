...
minetest.register_tool("walking_light:pick_mese", {
	...
	tool_capabilities = {
		...
		max_drop_level=3,
		groupcaps={
			cracky={times={[1]=0.5, [2]=0.3, [3]=0.1}, uses=20000, maxlevel=3},
			crumbly={times={[1]=0.5, [2]=0.3, [3]=0.1}, uses=20000, maxlevel=3},
			snappy={times={[1]=0.5, [2]=0.3, [3]=0.1}, uses=20000, maxlevel=3}
		},
